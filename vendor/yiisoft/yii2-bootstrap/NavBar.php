...
class NavBar extends Widget
{
    ...
    public function init()
    {
        ...
        if ($this->renderInnerContainer) {
            if (!isset($this->innerContainerOptions['class'])) {
                Html::addCssClass($this->innerContainerOptions, 'col-md-12');
            }
     ...
     */
    protected function renderToggleButtonBAK()
    {
    ...
    {
        $bar = Html::tag('span', '', ['class' => 'icon-bar']);
        $screenReader = "<span class=\"hamb-top\"></span><span class=\"hamb-middle\"></span><span class=\"hamb-bottom\"></span>";
